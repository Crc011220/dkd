<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="skuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="index" width="55" align="center" prop="skuId" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="skuRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number :min="0.01" :max="999999" :precision="2" :step="0.5" v-model="form.price"
...
function handleUpdate(row) {
  ...
  getSku(_skuId).then(response => {
    ...
    form.value.price /= 100 //单位转换 将分转成元
    open.value = true;
    title.value = "修改商品管理";
  });
}
...
function handleUploadSuccess(res, file) {
  if (res.code === 200) {
    proxy.$modal.msgError("上传Excel成功");
